...
$config = array(
    ...
    "key"              => "iCSr1FLxt6DDJdHYxw3nbXfzuE3cj2UJ", //Enter your consumer key here
    "secret"           => "oKjCvgzFtdUpSDlb", //Enter your consumer secret here
    "username"         => "apitest",
