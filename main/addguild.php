...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Register as a Woman's Guild Member
			</div>
			<ul class="breadcrumb">
      <li><a href="member.php">Dashboard</a></li> /
      <li><a href="group.php">Group</a></li> /
      <li><a href="guild.php">GUILD</a></li> /
			<li class="active">Register(GUILD)</li>
			</ul>
...
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="saveguild.php" method="post" enctype="multipart/form-data">
