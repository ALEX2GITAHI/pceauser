...
<a href="../index.php">Logout</a>
	...
	<div class="span2">
      ...
      <li><a href="editinfo.php"><i class="icon-pencil icon-2x"></i>Edit Profile</a>       </li>
			...
			<li><a href="infantreg.php"><i class="icon-sitemap icon-2x"></i>Registration</a>         </li>
...
<a href="viewinfo.php"><i class="icon-user icon-2x"></i><br>Profile</a> 
<a href="editinfo.php"><i class="icon-pencil icon-2x"></i><br>Edit Profile</a>
<a href="group.php"><i class="icon-sitemap icon-2x"></i><br> Groups</a>    
<?php
