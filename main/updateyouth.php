...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<li class="active">Update Youth Details</li>
			</ul>
...
<center><?php
	...
	$result = $db->prepare("SELECT * FROM youth WHERE username= :userid");
	$result->bindParam(':userid', $id);
	$result->execute();
	for($i=0; $row = $result->fetch(); $i++){
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="saveedityouth.php" method="post" enctype="multipart/form-data">
<center><h4><i class="icon-edit icon-large"></i> Edit Youth Details</h4></center>
<hr>
<div id="ac">
...
<select name="registered" value="<?php echo $row['registered']; ?>" style="width:265px; height:30px; margin-left:-5px;" >
<option>NO</option>
<option>CARD</option>
