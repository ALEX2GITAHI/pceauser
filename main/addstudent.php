...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Add Member
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li class="active">Add Memebr</li>
			</ul>


<div style="margin-top: -19px; margin-bottom: 21px;">
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><form action="savestudent.php" method="post" enctype="multipart/form-data"> <br>
