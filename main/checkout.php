...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Register For Only,  KES 100</h1> <!-- For testing purposes, we have added the amount manually. This should proceed from your website -->
    </div>
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2022 | All Rights Reserved | PCEA MUKINYI</p>
    <a  href="addyouth.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
