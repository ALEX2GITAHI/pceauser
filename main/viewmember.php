...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> Member Info
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Dashboard</a></li> /
			<li><a href="students.php">Member</a></li> /
...
<?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM member WHERE table_id= :userid");
...
<td style="padding: 10px;
				...
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['membership_id']; ?></td>
</tr>
<tr>
<td> Full Name :  </td>
<td style="padding: 10px;
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $checked; ?></td>
</tr>
