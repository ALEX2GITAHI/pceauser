...
<a href="../index.php">Logout</a>
	...
	<div class="contentheader">
			...
			<li class="active">PCMF</li>
			</ul>
			<font style=" font:bold 44px 'Aleo'; color:#722290;"><center>Mukinyi's MMS</center></font>
<div id="mainmain">           
<a href="addguild.php"><i class="icon-user icon-2x"></i><br>Register</a> 
<a href="updateguild.php"><i class="icon-group icon-2x"></i><br>Update Details</a>   
