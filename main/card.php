...
<a  href="youthinfo.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a> 

<table class="" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="12%"></th>
			<th width="16%"></th>
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['first_name']; ?> <?php echo $row['middle_name']; ?> <?php echo $row['last_name']; ?></td>
</tr>
<tr>
<td> Gender:  </td>
<td style="padding: 10px;
...
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['phone_number']; ?></td>
</tr>
<tr>
<td> District Name:  </td>
<td style="padding: 10px;
				...
				background-color: #f4f4f4;
				text-align: center;
				color: #7d7d7d;"> <?php echo $row['district_name']; ?></td>
</tr>
...
<?php
				...
				include('../connect.php');
				$result = $db->prepare("SELECT status FROM youth ");
				$result->execute();
				$row = $result->fetch();{
			?>
			<td class="btn btn-success btn-mini"> <?php echo "Youth Registration: " .$row['status']; ?>
