...
<div class="container-fluid">
	...
	<div class="contentheader">
      ...
      <li><a href="viewinfo.php">Profile</a></li> /
...
<span>Membership No.: </span><input type="text" style="width:265px; height:30px;"  name="membership_id" value="<?php echo $row['username']; ?>" readonly Required/><br>
