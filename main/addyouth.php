    ...
    <div class="row-fluid">
          ...
          <ul class="nav nav-list">
            ...
            <li>
              <div class="hero-unit-clock">
                ...
                <form name="clock">
                  <font color="white">Time: <br></font>&nbsp;<input style="width:150px;" type="submit" class="trans"
                    name="face" value="">
                </form>
              </div>
            </li>
      ...
      <div class="span10">
        <div class="contentheader">
          <i class="icon-table"></i> Register as a Youth Member
        </div>
        <ul class="breadcrumb">
          <li><a href="member.php">Dashboard</a></li> /
          <li><a href="group.php">Group</a></li> /
          <li><a href="youth.php">Youth</a></li> /
          <li class="active">Register(Youth)</li>
        </ul>

        <div style="margin-top: -19px; margin-bottom: 21px;">
          <a href="youth.php"><button class="btn btn-default btn-large" style="float: left;"><i
                class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
          <center><?php
          include ('../connect.php');
          $id = $_SESSION['SESS_MEMBER_ID'];
          $result = $db->prepare("SELECT * FROM membership WHERE username= :userid");
          $result->bindParam(':userid', $id);
          $result->execute();
          for ($i = 0; $row = $result->fetch(); $i++) {
            ?>
              <link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
              <form action="saveyouth.php" method="post" enctype="multipart/form-data">
                <center>
                ...
                <div id="ac">
                  ...
                  <span>Membership No.: </span><input type="text" style="width:265px; height:30px;" name="username"
                    value="<?php echo $row['username']; ?>" readonly Required /><br>
                  ...
                  <span>Middle Name : </span><input type="text" style="width:265px; height:30px;" name="middle_name"
                    value="<?php echo $row['middle_name']; ?>" /><br>
                  ...
                  <span>Date Of Birth: </span><input type="date" style="width:265px; height:30px;" name="DOB"
                    value="<?php echo $row['DOB']; ?>" /><br>
                  <span>District Name </span><select name="district_name"
                  ...
                  <span>Phone No : </span><input type="text" style="width:265px; height:30px;" name="phone_number"
                    value="<?php echo $row['phone_number']; ?>" name="parent" required /><br>
                  <div>
                    <span for="selectOption">Registered:</span>
                    <select name="registered" style="width:265px; height:30px; margin-left:-5px;" id="selectOption"
                      ...
                      <script>
                        function redirectToPage() {
                          // Get the selected value from the dropdown/select element
                          var selectedOption = document.getElementById("selectOption").value;

                          // Redirect the user to the selected PHP page
                    ...
                    <div> <br>
                      <button class="btn btn-success btn-block btn-large" style="width:267px;"><i
                          class="icon icon-save icon-large"></i> Register</button>
                    </div>
                  </div>
              </form>
              <?php
